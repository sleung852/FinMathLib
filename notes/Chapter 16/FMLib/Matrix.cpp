...
Matrix Matrix::transpose() {
    // make a copy
    Matrix ret(this->nRows(), this->nCols());
...
static void testMatrixMultiplication() {
    Matrix matA("1,0,0;0,0,0"); // 2x3
    Matrix matB("1,2,3;4,5,6;7,8,9"); // 3x3
    Matrix matC = matA * matB; // 2x3
    Matrix matExpected("1,2,3;0,0,0"); 
    matExpected.assertEquals(matC, 0.01);
}
